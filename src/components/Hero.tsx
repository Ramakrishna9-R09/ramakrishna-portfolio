...
export default function Hero({ activeTheme, setActiveTheme }: HeroProps) {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-start lg:items-center justify-center pt-24 pb-10 overflow-hidden bg-grid">
      {isEditMode && (
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div
          className={`absolute top-[-10%] left-1/2 -translate-x-1/2 w-[90%] md:w-[75%] h-[450px] rounded-full transition-all duration-1000 ${activeStyle.glowClass}`}
          style={{
            background:
              activeTheme === 'emerald'
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-[1.02fr_0.98fr] gap-8 lg:gap-10 items-center">
        <div className="text-left">
          ...
          <h1 className="text-4xl sm:text-5xl xl:text-7xl font-black font-display tracking-tight text-white mb-4 leading-[0.92]">
            Venkata Ramakrishna
            <span
              className="block mt-2 bg-gradient-to-r from-white via-white to-purple-400 bg-clip-text text-transparent transition-all duration-500"
              style={{
                backgroundImage:
                  activeTheme === 'emerald'
          ...
          <p className="text-lg md:text-2xl font-display font-semibold tracking-wide text-purple-200 mb-4 min-h-8">
            I build as a <span className="text-white border-r-2 border-purple-500 pr-1 animate-pulse">{currentText}</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center mb-6">
            <a
              ...
              target="_blank"
              className={`px-7 py-3.5 rounded-full bg-gradient-to-r font-semibold text-white shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 group cursor-pointer ${activeStyle.buttonClass}`}
            >
            ...
            <button
              ...
              className="px-7 py-3.5 rounded-full glass-pill hover:bg-white/10 font-semibold text-white hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 border border-white/15 cursor-pointer"
            >
            ...
            <div className="flex items-center gap-2">
              <a href="https://github.com/Ramakrishna9-R09" target="_blank" rel="noopener noreferrer" className="p-3.5 rounded-full glass-pill text-gray-300 hover:text-white" title="GitHub">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" />
                  <path d="M9 18c-4.51 2-5-2-7-2" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/in/venkata-ramakrishna-kamepalli-b60878290/" target="_blank" rel="noopener noreferrer" className="p-3.5 rounded-full glass-pill text-gray-300 hover:text-white" title="LinkedIn">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <div className="relative">
          <div className="glass-card rounded-[28px] border-white/10 overflow-hidden bg-black/70 shadow-2xl shadow-purple-950/30">
            <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 bg-white/[0.04]">
              ...
              <span className="text-[10px] font-mono uppercase tracking-widest text-emerald-300 bg-emerald-500/10 border border-emerald-500/20 px-2 py-1 rounded-full">ready</span>
            </div>
            ...
            <div className="p-5">
              ...
              <div className="mt-4 rounded-2xl border border-purple-500/20 bg-purple-500/10 p-3.5 flex items-start gap-3">
              ...
              <div className="mt-4 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-full p-1.5 backdrop-blur-md">
                  <button aria-label="Purple theme" onClick={() => setActiveTheme('purple')} className={`w-5 h-5 rounded-full bg-purple-500 border-2 cursor-pointer transition-transform ${activeTheme === 'purple' ? 'border-white scale-110' : 'border-transparent opacity-60 hover:opacity-100'}`} />
                  <button aria-label="Emerald theme" onClick={() => setActiveTheme('emerald')} className={`w-5 h-5 rounded-full bg-emerald-500 border-2 cursor-pointer transition-transform ${activeTheme === 'emerald' ? 'border-white scale-110' : 'border-transparent opacity-60 hover:opacity-100'}`} />
                  <button aria-label="Indigo theme" onClick={() => setActiveTheme('indigo')} className={`w-5 h-5 rounded-full bg-indigo-500 border-2 cursor-pointer transition-transform ${activeTheme === 'indigo' ? 'border-white scale-110' : 'border-transparent opacity-60 hover:opacity-100'}`} />
                </div>
              </div>
            </div>
          </div>
